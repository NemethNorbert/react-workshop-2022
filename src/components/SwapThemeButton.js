...
const SwapThemeButton = () => {
    ...
    return (
        <>
          <button className="theme-toggle-button" type="button" onClick={swapTheme}> 
          ...
          <div className="sun-moon-container center">
            <svg className="sun" style={{width:'24px', height:'24px'}} viewBox="0 0 24 24">
            ...
            <svg className="moon" style={{width:'24px', height:'24px'}} viewBox="0 0 24 24">
